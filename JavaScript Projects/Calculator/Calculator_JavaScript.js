...
const Calculator = {
    ...
    First_Operand: null, 
    // this checks whether of not the second operand has been input
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        //in the Perfrom_Calculation object and the function that matches the
...
keys.addEventListener('click', (event) => {
    ...
    //that was clicked
    const { target } = event;
    //if the element that was clicked on it not a buttom, exit the function
