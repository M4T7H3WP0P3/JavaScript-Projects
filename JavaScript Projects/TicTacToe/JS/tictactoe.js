...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //This condition checks to see if it is computers turns. 
        if(activePlayer === 'O'){
    ...
    //This function results in a randon square being selected. 
    function computersTurn() {
        ...
        while(!success){
            //A randon number between 0 and 8 is selected
...
function checkWinConditions(){
    ...
    //X 0, 3, 6 condition.
    else if (arrayIncludes('0X', '3X', '6X')) {drawWinLined(100, 50, 100, 558); }
    //X 1, 4, 7 condition. 
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 variables we apss are all included in our array true is returned and our else if condition executes the drawWinLine function. 
...
//This function takes a string parameters for the path you set earlier for placement sound ('./media/place.mp3')
